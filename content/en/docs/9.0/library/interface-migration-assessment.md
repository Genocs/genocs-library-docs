---
title: "Interface Migration Assessment"
description: "This document provides an assessment of interfaces in **Genocs.Core** that can be moved to **Genocs.Common** based on the requirement that Genocs.Common must ha..."
lead: "This document provides an assessment of interfaces in **Genocs.Core** that can be moved to **Genocs."
...
menu:
  docs:
    parent: "library"
    identifier: "interface-migration-assessment"
weight: 390
toc: true
---
