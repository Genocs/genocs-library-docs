...
menu:
  templating:
    identifier: "templating-general-api-testing"
    name: "API Testing"
    parent: "general"
weight: 3
toc: true
...
Now that our application is up and running, let's fire up POSTMAN and run some basic requests. You can find the updated Postman collection under the /postman folder of your solution or [here](https://github.com/Genocs/genocs-templates/blob/main/postman/dotnet.webapi.template.postman_collection.json). Import this postman collection on to your local Postman.
